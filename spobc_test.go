...
func TestAffectingGenesis(t *testing.T) {
	...
	// Execute
	inputs, err := spobc.FindAffectingInputs(genesis, msgTx, outputs)
	if err != nil {
		t.Fatalf("err on calculating out color values: %v", err)
	}
...
func TestAffectingNil(t *testing.T) {
	...
	// Execute
	inputs, err := spobc.FindAffectingInputs(genesis, msgTx, nil)
	if err != nil {
		t.Fatalf("err on calculating out color values: %v", err)
	}
...
OUTER:
	for _, test := range tests {
		...
		// Execute
		inputs, err := spobc.FindAffectingInputs(genesis, msgTx, test.outputIndexes)
		if err != nil {
...
func TestAffectingError(t *testing.T) {
	...
	for _, test := range tests {
		...
		// Execute
		_, err = spobc.FindAffectingInputs(genesis, msgTx, test.outputs)
